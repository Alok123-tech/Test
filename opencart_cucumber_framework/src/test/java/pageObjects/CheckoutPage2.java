...
public class CheckoutPage2 {
	 ...
	 private static CheckoutPage2 instance;
	    private WebDriver driver;

	    // Private constructor
	    private CheckoutPage2(WebDriver driver) {
	    this.driver = driver;
	    }
	    ...
	    public String getCost() {
	    	By cost = By.xpath("//*[contains(text(),'Apple iPhone 14 (Blue, 128 GB)')]/../following-sibling::div[@class='col col-5-12 BfVC2z']/descendant::div[@class='Nx9bqj _4b5DiR']");// Replace with your actual locator
